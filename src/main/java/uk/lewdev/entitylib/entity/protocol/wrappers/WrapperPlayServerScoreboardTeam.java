...
public class WrapperPlayServerScoreboardTeam extends AbstractPacket {
     ...
     * <p>
     * Notes: only if Mode = 0 or 2. Displayed after the players' name that are part
     * of this team.
     * 
    ...
    /**
     * Get the collision rule. Notes: only if Mode = 0 or 2. always, pushOtherTeams,
     * pushOwnTeam, never.
     * 
     ...
     * Max 40 characters so may be uuid's later
     * 
     ...
     * Retrieve Mode.
     * <p>
     * Notes: if 0 then the team is created. If 1 then the team is removed. If 2 the
